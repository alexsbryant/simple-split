...
## Phase 16 – Expense Reactions & Comments - Complete
...
## Phase 17 - Notifications and Settings Nav Updates

I'd like to add a notification icon menu button at the top right, leading to a notification drop down menu.

Notificatinos to include:
  - New expense added to {group name} by {other user}
  - {other user} reacted to your expense
  - {other user} commented on your expense

Settings to change from a page to a drop-down menu.  Slim options for everything that currently lives on the settings page. 
'Log out' button to move to bottom of settings menu.

New Nav bar should be Icon/'Settle' left aligned --- 'Groups', 'Notifications' and 'Settings' aligned right.  
...
Phase 17C (Sonnet again):
	•	Wire notification dropdown to data
	•	Badge count
	•	Navigation on click
