            ...
            trigger={
              ...
              >
                ...
                {unreadNotifications > 0 && (
                  <span className="absolute top-1 right-1 w-2 h-2 bg-red-500 rounded-full opacity-80" />
                )}
              </button>
            }
          >
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="relative">
                    ...
                    {unreadNotifications > 0 && (
                      <span className="absolute -top-0.5 -right-0.5 w-2 h-2 bg-red-500 rounded-full opacity-80" />
                    )}
                  </div>
                  Notifications
                </div>
